...
<body>
    <header>
        <nav>
            ...
            <ul class="nav-list">
                <li><a href="/php/TelaInicial.php">Início</a></li>
    ...
    <main>
        ...
        <div class="modal-HQ1">
            <div class="modal-base modal-HQ">
                ...
                <hr />
                <span>
                    <img src="/Imagens/HQ1.jpg" style="width: 500px; height: 500px;">
                    <br>
                    <p
        ...
        <div class="modal-HQ4">
            <div class="modal-base modal-HQ">
                ...
                <hr />
                <span>
                    <img src="/Imagens/HQ4.png" style="width: 500px; height: 400px;">
                    <br>
                    <p
                        style="font-family: 'Lucida Sans', 'Lucida Sans Regular', 'Lucida Grande', 'Lucida Sans Unicode', Geneva, Verdana, sans-serif;">
                        <strong>Escreva o que você entendeu nos quadrinhos!</strong>
        ...
        <div class="modal-HQ5">
            <div class="modal-base modal-HQ">
                ...
                <hr />
                <span>
                    <img src="/Imagens/HQ5.png" style="width: 500px; height: 510px;">
                    <br>
                    <p
                        style="font-family: 'Lucida Sans', 'Lucida Sans Regular', 'Lucida Grande', 'Lucida Sans Unicode', Geneva, Verdana, sans-serif;">
                        <strong>Escreva o que você entendeu nos quadrinhos!</strong>
