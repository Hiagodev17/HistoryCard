...
<head>
    ...
    <title>Trilha-Primeira Guerra Mundial</title>
...
<body>
    ...
    <main>
        <div class="titulo">
            <img id="fotoprinc" src="Imagens/simboloPGM.png">
        ...
        <div class="modal-parabens">
            <div class="modal-base modal-contexto">
                ...
                <span>
                    ...
                    <strong>
                        <p style=" font-size: 30px;">Parabéns! Você concluío o card da Primeira Guerra Mundial.<br>Vamos
        ...
        <div class="modal-contexto1">
            <div class="modal-base modal-contexto">
                ...
                <hr />
                <span>
                    <img src="Imagens/PGM-contexto1.png" style="height: 300px; width: 600px"><br>
                    <audio controls="controls">
                        <source src="audios/PGM-1.mp3" type="audio/mp3" />
                    </audio>
                </span>
                <hr />
                <div class="btns">
        ...
        <div class="modal-contexto2">
            <div class="modal-base modal-contexto">
                ...
                <hr />
                <span>
                    <img src="Imagens/PGM-contexto2.png" style="height: 350px; width: 550px;"><br>
                    <audio controls="controls">
                        <source src="audios/PGM-2.mp3" type="audio/mp3" />
                    </audio>
                </span>
                <hr />
                <div class="btns">
        ...
        <div class="modal-contexto3">
            <div class="modal-base modal-contexto">
                ...
                <hr />
                <span>
                    <img src="Imagens/PGM-contexto3.png" style="height: 350px; width: 650px;"><br>
                    <audio controls="controls">
                        <source src="audios/PGM-3.mp3" type="audio/mp3" />
                    </audio>
                </span>
                <hr />
                <div class="btns">
        ...
        <div class="modal-contexto4">
            <div class="modal-base modal-contexto">
                ...
                <hr />
                <span>
                    <img src="Imagens/PGM-contexto4.png" style="height: 350px; width: 650px;"><br>
                    <audio controls="controls">
                        <source src="audios/PGM-4.mp3" type="audio/mp3" />
                    </audio>
                </span>
                <hr />
                <div class="btns">
        ...
        <div class="modal-contexto5">
            <div class="modal-base modal-contexto">
                ...
                <hr />
                <span>
                    <img src="Imagens/PGM-contexto5.png" style="height: 350px; width: 650px;"><br>
                    <audio controls="controls">
                        <source src="audios/PGM-5.mp3" type="audio/mp3" />
                    </audio>
                </span>
                <hr />
                <div class="btns">
        ...
        <div class="modal-pergunta1">
            <div class="modal-base modal-pergunta">
                ...
                <button class="opcao" onclick="responder(1, false)">1912</button>
                <button class="opcao" onclick="responder(1, true)">1914</button>
                <button class="opcao" onclick="responder(1, false)">1916</button>
                <button class="opcao" onclick="responder(1, false)">1920</button>
        ...
        <div class="modal-pergunta2">
            <div class="modal-base modal-pergunta">
                <h2 >Qual foi o estopim da Primeira Guerra Mundial?</h2>
                <button class="opcao" onclick="responder(2, false)">Uma eleição na França</button>
                <button class="opcao" onclick="responder(2, false)">A morte do presidente dos EUA</button>
                <button class="opcao" onclick="responder(2, false)">Uma guerra entre Japão e China</button>
                <button class="opcao" onclick="responder(2, true)">O assassinato do arquiduque Francisco Ferdinando</button>
        ...
        <div class="modal-pergunta3">
            <div class="modal-base modal-pergunta">
                <h2>Qual foi uma das principais causas da primeira guerra?</h2>
                <button class="opcao" onclick="responder(3, false)">A descoberta da América</button>
                <button class="opcao" onclick="responder(3, false)">A Revolução Francesa</button>
                <button class="opcao" onclick="responder(3, true)">A rivalidade entre países europeus</button>
                <button class="opcao" onclick="responder(3, false)">O ataque às Torres Gêmeas</button>
        ...
        <div class="modal-pergunta4">
            <div class="modal-base modal-pergunta">
                <img src="Imagens/PGM-pergunta4.png" style="width: 250px; height: 200px;">
                <h2>O que é "trincheira" na Primeira Guerra?</h2>
                <button class="opcao" onclick="responder(4, false)">Uma arma de fogo</button>
                <button class="opcao" onclick="responder(4, false)">Um avião de combate</button>
                <button class="opcao" onclick="responder(4, true)">Um buraco onde os soldados se escondiam</button>
                <button class="opcao" onclick="responder(4, false)">Um tipo de bomba</button>
        ...
        <div class="modal-pergunta5">
            <div class="modal-base modal-pergunta">
                <img src="Imagens/PGM-pergunta5.png" style="width: 230px; height: 180px;">
                <h2>Que país saiu da guerra em 1917 por causa de uma revolução?</h2>
                <button class="opcao" onclick="responder(5, false)">Alemanha</button>
                <button class="opcao" onclick="responder(5, true)">Rússia</button>
                <button class="opcao" onclick="responder(5, false)">Reino Unido</button>
                <button class="opcao" onclick="responder(5, false)">França</button>
        ...
        <div class="modal-video1">
            <div class="modal-base modal-video">
                ...
                <hr />
                <span>
                    <iframe width="706" height="397" src="https://www.youtube.com/embed/IxMh0mCwBNc?si=1osBCHSkhUQUZdJJ" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
                </span>
                <hr />
                <div class="btns">
        ...
        <div class="modal-HQ1">
            <div class="modal-base modal-HQ">
                ...
                <hr />
                <span>
                    <img src="Imagens/PGM-HQ1.jpg" style="width: 340px; height: 360px;">
                    <br>
                    <p
        ...
        <div class="modal-HQ2">
            <div class="modal-base modal-HQ">
                ...
                <hr />
                <span>
                    <img src="Imagens/PGM-HQ2.png" style="width: 500px; height: 300px;">
                    <br>
                    <p
                        style="font-family: 'Lucida Sans', 'Lucida Sans Regular', 'Lucida Grande', 'Lucida Sans Unicode', Geneva, Verdana, sans-serif;">
                        <strong>Escreva o que você entendeu nos quadrinhos!</strong>
        ...
        <div class="modal-HQ3">
            <div class="modal-base modal-HQ">
                ...
                <hr />
                <span>
                    <img src="Imagens/PGM-HQ.png" style="width: 700px; height: 300px;">
                    <br>
                    <p
                        style="font-family: 'Lucida Sans', 'Lucida Sans Regular', 'Lucida Grande', 'Lucida Sans Unicode', Geneva, Verdana, sans-serif;">
                        <strong>Escreva o que você entendeu nos quadrinhos!</strong>
        ...
        <div class="modal-HQ4">
            <div class="modal-base modal-HQ">
                ...
                <hr />
                <span>
                    <img src="Imagens/PGM-HQ4.png" style="width: 300px; height: 350px;">
                    <br>
                    <p
                        style="font-family: 'Lucida Sans', 'Lucida Sans Regular', 'Lucida Grande', 'Lucida Sans Unicode', Geneva, Verdana, sans-serif;">
                        <strong>Escreva o que você entendeu nos quadrinhos!</strong>
        ...
        <div class="modal-HQ5">
            <div class="modal-base modal-HQ">
                ...
                <hr />
                <span>
                    <img src="Imagens/PGM-HQ5.png" style="width: 350px; height: 350px;">
                    <br>
                    <p
                        style="font-family: 'Lucida Sans', 'Lucida Sans Regular', 'Lucida Grande', 'Lucida Sans Unicode', Geneva, Verdana, sans-serif;">
                        <strong>Escreva o que você entendeu nos quadrinhos!</strong>
...
<script src="js/PrimeiraGuerra.js"></script>
