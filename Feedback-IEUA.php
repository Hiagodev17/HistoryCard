...
<head>
    ...
    <title>Feedback - Indepêndencia dos Estados Unidos</title>
        ...
        <div class="feedback-wrapper">
            <div class="feedback-card">
                <div class="feedback-header">
                    <h1>Seu Progresso</h1>
                    <p>Confira como foi seu desempenho na trilha da Indepêndencia dos Estados Unidos</p>
                </div>
